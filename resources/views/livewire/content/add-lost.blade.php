<div class="modal fade" id="lost-copies-modal" wire:ignore.self>
            ...
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body">
                        <form wire:submit.prevent="addLost">
                            @csrf
                            <input type="hidden" wire:model="inventory_id">
                            <div class="card mb-0">
                                <div class="card-body">
                                    <div class="new-book-field">
                                        <div class="card-title-head" wire:ignore>
                                            <h6><span><i data-feather="info" class="feather-edit"></i></span>Lost Copies Information</h6>
                                        </div>
                                        <div class="row">
    ...
    @push('scripts')
        <script>
            ...
            function handleLostCopiesActions() {
                $(document).on('change', '[id]:not([type="date"]):not([type="time"])', handleInputChange);
                $(document).on('click', '.lost-copies', openLostCopiesModal);
            }
