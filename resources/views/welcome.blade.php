...
<body class="index-page">
    ...
    <main class="main">
        ...
        <section id="available" class="services section ">
            ...
            <div class="mb-1 container d-flex justify-content-end">
                <input type="text" class="input w-100 me-1 ps-3" placeholder="Search for books..." id="searchInput" style="max-width: 420px">
            </div>
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="gy-1">
                    <div class=" gy-2">
                        <section class="row pt-4" id="available-books-container">
                            <div class="col-lg-3">
                                ...
                                <svg class="card__clock" viewBox="0 0 24 24">
                                    ...
                                    <a href="#" class="card_link">
                                        <div class="card__img--hover"
                                            style="background-image: url({{ $bookPhotoPath }});"></div>
                                    </a>
                                    <div class="card__info">
                                        <span
                                            class="card__category">{{ \Carbon\Carbon::parse($top_book->published_date)->year }}</span>
                                        <h4 class="card__title">{{ $top_book->title }}</h4>
                                        <span class="card__by">by <a href="#" class="card__author"
                                                title="author">{{ $top_book->author }}</a></span>
                                    </div>
                                </article>
                            </div>
                        @endforeach
