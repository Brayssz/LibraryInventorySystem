...
@section('content')
    ...
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a class="btn btn-added add-school"><i data-feather="plus-circle" class="me-2"></i>Add New
                    School</a>
            </div>
        </div>
        <!-- /school list -->
        <div class="card table-list-card">
            <div class="card-body pb-0">
                ...
                <div class="table-responsive">
                    <table class="table school-table pb-3">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Address</th>
    ...
    @livewire('content.school-management')
                        ...
                        "render": function (data, type, row) {
                            return `
                                <div class="edit-delete-action">
                                    <a class="me-2 p-2 edit-school" data-schoolid="${row.school_id}">
