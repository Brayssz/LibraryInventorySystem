...
<head>
    ...
    <title>Books Distribution Report</title>
    <style>
        @font-face {
...
<body>
    <header>
        <div class="header">
            ...
            <h3 style="text-align: center; margin-top: 0px;">Books Distribution Report</h3>
        ...
        <table style="width: 100%; margin-top: 10px; border-collapse: collapse; border: none;">
            <tr>
                <td style="width: 33%; text-align: left; vertical-align: top; border: none;">
                    <img src="{{ public_path('img/deped-matatag-logos.png') }}" alt="Logo" style="width: 140px; margin-right: 5px;">
                    <img src="{{ public_path('img/logo.jpg') }}" alt="Logo" style="width: 65px;">
                </td>
                <td style="width: 57%; text-align: left; vertical-align: top; border: none; font-size: 11px; padding: 0px !important; font-family: Arial, sans-serif;">
                    <p style="margin: 1px 0;"><strong>Address:</strong> Jaycee Avenue, Corner Rizal St., Brgy. Zone IV, City of Koronadal</p>
        ...
        <tbody>
            @forelse ($report as $record)
                <tr>
                    ...
                    <td>{{ $record['quantity_released'] }}</td>
