        ...
        <div class="page-header">
            <div class="add-item d-flex">
                <div class="page-title">
                    ...
                    <h6>Monitor the returned book transactions</h6>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.btn-generate').on('click', function () {
                window.open('/generate-returned-books-report?date_range=' + $('.daterange_filter').val(), '_blank');
            });
